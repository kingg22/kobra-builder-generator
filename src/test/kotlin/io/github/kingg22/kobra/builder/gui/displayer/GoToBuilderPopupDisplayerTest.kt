...
class GoToBuilderPopupDisplayerTest {
    @Mock
    ...
    fun shouldInvokePopupChooserBuilder() {
        ...
        given(popupChooserBuilder.setItemChosenCallback(any(Runnable::class.java)))
            .willReturn(popupChooserBuilder)
        ...
        // when
        GoToBuilderPopupDisplayer().displayPopupChooser(editor, list) {}
