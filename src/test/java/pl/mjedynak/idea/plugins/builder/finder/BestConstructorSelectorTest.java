...
public class BestConstructorSelectorTest {
    ...
    @Mock
    private PsiMethod constructor0;

    @Mock
    private PsiMethod constructor1;

    @Mock
    private PsiMethod constructor2a;

    @Mock
    private PsiMethod constructor2b;

    @Mock
    private PsiMethod constructor3;

    @Mock(strictness = LENIENT)
    private PsiParameterList parameterList0;

    @Mock(strictness = LENIENT)
    private PsiParameterList parameterList1;

    @Mock(strictness = LENIENT)
    private PsiParameterList parameterList2a;

    @Mock(strictness = LENIENT)
    private PsiParameterList parameterList2b;

    @Mock(strictness = LENIENT)
    private PsiParameterList parameterList3;
    ...
    @Mock(strictness = LENIENT)
    private PsiField psiField3;

    @Mock(strictness = LENIENT)
    private PsiField psiField4;

    @Mock(strictness = LENIENT)
    private PsiField psiField5;

    @Mock(strictness = LENIENT)
    private PsiParameter psiParameter1;

    @Mock(strictness = LENIENT)
    private PsiParameter psiParameter2;

    @Mock(strictness = LENIENT)
    private PsiParameter psiParameter3;
    ...
    private void mockConstructor(
            PsiParameterListOwner constructor, PsiParameterList parameterList, PsiParameter... psiParameters) {
