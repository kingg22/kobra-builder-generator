...
public class ButMethodCreatorTest {
    ...
    @Mock
    private PsiMethod method1;

    @Mock
    private PsiMethod method2;

    @Mock
    private PsiMethod method3;

    @Mock
    private PsiMethod createdMethod;

    @Mock
    private PsiParameterList parameterList1;

    @Mock
    private PsiParameterList parameterList2;
    ...
    void shouldCreateButMethodForSingleField() {
        ...
        initOtherCommonMocks();
        given(psiElementFactory.createMethodFromText(
                        "public Builder but() { return aBuilder().withAge(className.getAge()); }", srcClass))
                .willReturn(createdMethod);
